...
```{r, message = F, warning = F, fig.width = 8, fig.height = 6, results = 'hide'}
...
```{r, message = F, warning = F, fig.width = 9, fig.height = 7, results = 'hide'}
...
```{r, message = F, warning = F, fig.width = 12, fig.height = 5, results = 'hide'}
...
```{r, message = F, warning = F, fig.width = 10, fig.height = 6, results = 'hide'}
...
```{r, message = F, warning = F, fig.width = 20, fig.height = 42, results = 'hide'}
...
```{r, message = F, warning = F, fig.width = 12, fig.height = 8, results = 'hide'}
...
```{r, message = F, warning = F, fig.width = 20, fig.height = 36, results = 'hide'}
