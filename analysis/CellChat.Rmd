...
unique(CC_merged_object@meta$annot)

# Compare all the interactions sending from CD4
netVisual_bubble(CC_merged_object, sources.use = 6,
                 targets.use = setdiff(seq(1, length(celltypes)), c(6)),
                 thresh = 1, comparison = c(1, 2), angle.x = 45)

netVisual_bubble(CC_merged_object, sources.use = 10,
                 targets.use = setdiff(seq(1, length(celltypes)), c(10)),
                 thresh = 1, comparison = c(1, 2), angle.x = 45)

netVisual_bubble(CC_merged_object, sources.use = 13,
                 targets.use = setdiff(seq(1, length(celltypes)), c(13)),
                 thresh = 1, comparison = c(1, 2), angle.x = 45)
