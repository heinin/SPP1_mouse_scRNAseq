...
myeloid <- readRDS("/tgen_labs/banovich/BCTCSF/SPP1_mouse_scRNAseq/scRNAseq_Seurat_dim8_myeloid.rds")
...
seurat_data$myeloid_annot <- mapvalues(x = rownames(seurat_data@meta.data),
                                       ...
                                       to = as.character(myeloid$myeloid_annot))
...
lymphoid <- readRDS("/tgen_labs/banovich/BCTCSF/SPP1_mouse_scRNAseq/scRNAseq_Seurat_dim8_lymphoid.rds")
...
saveRDS(seurat_data, "/tgen_labs/banovich/BCTCSF/SPP1_mouse_scRNAseq/scRNAseq_Seurat_dim8_granular_annot.rds")
