...
```{r, message = F, warning = F, fig.width = 4, fig.height = 4, results = 'hide', eval = T}
...
# Calling doublets
seurat_list <- run_sctransform(seurat_list, vars_to_regress = vars_to_regress)
...
```{r, message = F, warning = F, fig.width = 8, fig.height = 8, results = 'hide', eval = T}
